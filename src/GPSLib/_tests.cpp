...
int main()
{
    ...
    const char msg_3[] = "$GPRMC,17348445,N,09445.4171,W,0.83,338.57,140520,,,A*7B";

    bool checksum_0 = NmeaParser::checksum(msg_0, sizeof(msg_0) - 1);
    bool checksum_1 = NmeaParser::checksum(msg_1, sizeof(msg_1) - 1);
    bool checksum_2 = NmeaParser::checksum(msg_1, sizeof(msg_2));
    bool checksum_3 = NmeaParser::checksum(msg_3, sizeof(msg_3));
